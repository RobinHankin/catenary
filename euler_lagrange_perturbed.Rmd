...
\frac{\cosh^3 x + \lambda\cosh x}{\cosh^3 x} - \frac{2\cosh x}{\cosh x}
...
+ z''\left(\frac{\cosh^2x}{\cosh^3 x}\right) &=& 0\nonumber\\
  \frac{\lambda}{\cosh^2 x} - 1
+ \frac{2z}{\cosh x}
+ z'\left(\frac{-3\sinh x}{\cosh^2 x}-\frac{\sinh x}{\cosh^3 x}\right)
+ \frac{z''}{\cosh x} &=& 0\\
z'' - \tanh x(3 + \operatorname{sech} x)z'  +2z &=& 1-\lambda\operatorname{sech} x
\nonumber
\end{eqnarray}
