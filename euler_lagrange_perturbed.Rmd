...
$z(-1)=z(1)=0$ results in just the trivial solution.
...
(jj <- optim(c(0,0.1), badness, hessian=TRUE))
eigen(jj$hessian)
```
...
\el{F} &=& \frac{d}{dx}\left[\frac{(y+\Lambda)y'}{\sqrt{1+y'^2}}\right] - \sqrt{1+y'^2}\nonumber\\
       &=& \frac{y''(y+\Lambda)}{(1+y'^2)^{3/2}} + \frac{y'^2}{\sqrt{1+y'^2}} - \sqrt{1+y'^2}\nonumber\\
       &=& \frac{y''(y+\Lambda)}{(1+y'^2)^{3/2}} - \frac{1}{\sqrt{1+y'^2}}
\end{eqnarray}

and because $\di{G}{y'}=\lambda y'/\sqrt{1+y'^2}$ we have

\begin{eqnarray}
\el{G} &=& \frac{d}{dx}\di{G}{y'}\nonumber\\
       &=& \frac{d}{dx}\left[\frac{\lambda y'}{\sqrt{1+y'^2}}\right]\nonumber\\
       &=& \frac{\lambda y''}{(1+y'^2)^{3/2}}\label{elG2}\\
\end{eqnarray}
...
\begin{eqnarray}
\el{G} + \left(z\di{}{y} + z'\di{}{y'} + z''\di{}{y''}\right)
\left(\el{F}\right) &=& 0\end{eqnarray}

The first term is just $\frac{\lambda y''}{(1+y'^2)^{3/2}}$ (from
equation \ref{elG2}) and the second is from equation
\ref{zyzdddyzdddydd}:

\begin{eqnarray}
\frac{\lambda y''}{(1+y'^2)^{3/2}} 
+ z  \left(\frac{y''}{(1+y'^2)^{3/2}}\right)
+ z' \left(\frac{-3(y+\Lambda)y'y''}{(1+y'^2)^{5/2}} - \frac{y'}{(1+y'^2)^{3/2}}\right)
+ z''\left(\frac{y+\Lambda}{(1+y'^2)^{3/2}}\right) &=& 0
\end{eqnarray}
...
Again we specify $\Lambda=0$ and $y=y''=\sqrt{1+y'^2}=\cosh x$,
$y'=\sinh x$ to get 
...
The inhomogeneous term is $\lambda/\cosh^2x$.

\begin{equation}
z'' - 4z'\tanh x -z = \lambda\operatorname{sech}^2 x
\end{equation}
