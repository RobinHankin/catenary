...
&=& \sqrt{r^2+r'^2} +  M\frac{r'^2}{r\sqrt{r^2+r'^2}}
\end{eqnarray}

so $G=M\frac{r'^2}{r\sqrt{r^2+r'^2}}$.
...
&=&
\frac{d}{dx}\left(\frac{2r^2r' + r'^3}{r(r^2+r'^2)^{3/2}}\right)
+ \frac{r'^2(2r^2 + r'^2)}{r^2(r^2+r'^2)^{3/2}}\nonumber\\
&=&
\frac{-4r^4 -2r^2r'^4-r'^6+2r^5r''-r^3r'^2r''}{r^2(r^2+r'^2)^{5/2}}
+ \frac{r'^2(2r^2 + r'^2)}{r^2(r^2+r'^2)^{3/2}}\nonumber\\
&=& \underbrace{\frac{(2r^2-r'^2)(rr''-r'^2)}{(r^2+r'^2)^{5/2}}}_{\mbox{check}}
\end{eqnarray}
...
+z''\sec^6\theta  &=&
\sec^6\theta(\tan^2\theta -2)
\nonumber\\
z(1-2\tan^2\theta) - 4z'\tan \theta + z'' &=& \tan^2\theta -2\nonumber\\
...
blackhole <- function(t, state, parameters) {
    with(as.list(c(state, parameters)), {
        ...
        dZdash <- 4*Zdash*tan(x) - Z*(1-2*tan(x)^2) + (tan(x)^2-2)
