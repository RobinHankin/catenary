...
\frac{(y^2+\Lambda)y''}{(1+y'^2)^{3/2}} - \frac{2y}{\sqrt{1+y'^2}}
+ z  \left(\frac{2yy''}{(1+y'^2)^{3/2}} - \frac{2}{\sqrt{1+y'^2}}\right)\nonumber\\
