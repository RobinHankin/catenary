...
\begin{eqnarray}
&{}& \left(z\di{}{y} + z'\di{}{y'} + z''\di{}{y''}\right)vF\\
&=&
\Lambda\left[
...
&=& \lambda\left(\frac{y'}{\sqrt{1+y'^2}} + \frac{x}{(1+y'^2)^{3/2}}\right)-2xy
\end{eqnarray}
...
\frac{-x}{\sqrt{1-x^2}}$ and $1+y'^2=\frac{1}{1-x^2}$, which makes
things a lot easier:

\begin{eqnarray}
\lambda\left(\frac{\frac{-x}{\sqrt{1-x^2}}}{\frac{1}{1-x^2}} + \frac{x}{\left(\frac{1}{1-x^2}\right)^{3/2}}\right)-2x\left(\sqrt{1-x^2}-\frac{\sqrt{2}}{2}\right)
