...
switch to coordinates $y^\star = y-y_0$ in which the potential energy
is $(y^\star+y_0)^2/2$, corresponding to an off-axis troposkein.  The
potential field would be $y_0y^\star + (y^\star)^2/2$, up to a
constant.  Dropping the star for convenience and rescaling gives us
