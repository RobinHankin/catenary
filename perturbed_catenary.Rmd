...
powers.  We assume that the chain adopts a slightly perturbed form and
perturb with $\epsilon$, sufficiently small to neglect powers above
the second:
...
(above we have to remember that $G=G(x,y,y')$).  Before we apply it to
the catenary we need to consider the form of $G$, which will include a
constraint.  We have $F=\sqrt{1+y'^2}(y+\lambda)$ giving
