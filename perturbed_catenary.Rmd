...
So of course, if $\lambda=\infty$ we can simultaneously satisfy the
length constraint and also $z(x_1)=z(x_2)=0$ by taking $C=0$.  The
question is, can we find another (non-infinite) value of $\lambda$ and
