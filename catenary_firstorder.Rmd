...
\frac{y''(y + \lambda)}{(1+y'^2)^{3/2}} + \frac{y'}{\sqrt{1+y'^2}}        &=& \sqrt{1+y'^2}
\end{eqnarray}
...
&=& \frac{d}{dx}\left[\frac{Y'}{\sqrt{1+Y'^2}}(Y + \Lambda + \epsilon\phi(x,Y))\right]\\
&=& \frac{Y''}{(1+Y'^2)^{3/2}}(Y + \Lambda + \epsilon\phi(x,Y)) + 
        \frac{Y'}{\sqrt{1+Y'^2}}(1 + \epsilon(\phi_x + y'\phi_y))\\
&=& \frac{y'' + \epsilon z''}{(1+(y'+\epsilon z')^2)^{3/2}}(y(x) + \epsilon z + \Lambda + \epsilon\phi) + 
        \frac{y'}{\sqrt{1+(y'+\epsilon z')^2}}(1 + \epsilon(\phi_x + y'\phi_y))\\
&=& \left(\frac{y''}{(1+(y'+\epsilon z')^2)^{3/2}} + 
\frac{\epsilon z''}{(1+(y'+\epsilon z')^2)^{3/2}}\right)(y(x) + \epsilon z + \Lambda + \epsilon\phi)\nonumber\\
&{}& \qquad + \frac{y'}{\sqrt{1+(y'+\epsilon z')^2}}(1 + \epsilon(\phi_x + y'\phi_y))\\
&=& \left(\frac{y''}{(1+(y'+\epsilon z')^2)^{3/2}} + 
\frac{\epsilon z''}{(1+(y'+\epsilon z')^2)^{3/2}}\right)(y(x) + \epsilon z + \Lambda + \epsilon\phi)\nonumber\\
&{}& \qquad + \left(\frac{y'}{\sqrt{1+y'^2}} + \epsilon\frac{z'}{(1+y'^2)^{3/2}}\right)(1 + \epsilon(\phi_x + y'\phi_y))\\
&=& \left(\frac{y''}{(1+(y'+\epsilon z')^2)^{3/2}} + 
\frac{\epsilon z''}{(1+(y'+\epsilon z')^2)^{3/2}}\right)(y(x) + \epsilon z + \Lambda + \epsilon\phi)\nonumber\\
&{}& \qquad + \frac{y'}{\sqrt{1+y'^2}} + \epsilon\frac{z'}{(1+y'^2)^{3/2}} + \epsilon\frac{y'(\phi_x + y'\phi_y)}{\sqrt{1+y'^2}}\\
&=& \left(\frac{y''}{(1+(y'+\epsilon z')^2)^{3/2}} + 
\frac{\epsilon z''}{(1+y'^2)^{3/2}}\right)(y(x) + \epsilon z + \Lambda + \epsilon\phi)\nonumber\\
&{}& \qquad + \frac{y'}{\sqrt{1+y'^2}} + \epsilon\frac{z'}{(1+y'^2)^{3/2}} + \epsilon\frac{y'(\phi_x + y'\phi_y)}{\sqrt{1+y'^2}}\\
&=& \left(\frac{y''}{(1+y'^2)^{3/2}}  -3 \frac{\epsilon z'y'y''}{(1+y'^2)^{5/2}} + 
\frac{\epsilon z''}{(1+y'^2)^{3/2}}\right)(y(x) + \epsilon z + \Lambda + \epsilon\phi)\nonumber\\
&{}& \qquad + \frac{y'}{\sqrt{1+y'^2}} + \epsilon\frac{z'}{(1+y'^2)^{3/2}} + \epsilon\frac{y'(\phi_x + y'\phi_y)}{\sqrt{1+y'^2}}\\
&=& \frac{y''(y+\Lambda)}{(1+y'^2)^{3/2}} + \epsilon\frac{y''(z+\phi)}{(1+y'^2)^{3/2}} 
-3 \frac{\epsilon z'y'y''(y+\Lambda)}{(1+y'^2)^{5/2}} + 
\frac{\epsilon z''(y+\Lambda)}{(1+y'^2)^{3/2}}\nonumber\\
&{}& \qquad + \frac{y'}{\sqrt{1+y'^2}} + \epsilon\frac{z'}{(1+y'^2)^{3/2}} + \epsilon\frac{y'(\phi_x + y'\phi_y)}{\sqrt{1+y'^2}}\\
&=&  \frac{y''(y+\Lambda)}{(1+y'^2)^{3/2}} + \frac{y'}{\sqrt{1+y'^2}}
+ \epsilon\frac{y''(z+\phi)}{(1+y'^2)^{3/2}}
+  (-3) \frac{\epsilon z'y'y''(y+\Lambda)}{(1+y'^2)^{5/2}}
+  \frac{\epsilon z''(y+\Lambda)}{(1+y'^2)^{3/2}}\nonumber\\
&{}& \qquad
+ \epsilon\frac{z'}{(1+y'^2)^{3/2}}
+ \epsilon\frac{y'(\phi_x + y'\phi_y)}{\sqrt{1+y'^2}}\\
&=&  \left(\frac{y''(y+\Lambda)}{(1+y'^2)^{3/2}} + \frac{y'}{\sqrt{1+y'^2}}\right)\nonumber\\
&{}&
+ \epsilon\left(
    \frac{y''(z+\phi)}{(1+y'^2)^{3/2}}
-  3\frac{z'y'y''(y+\Lambda)}{(1+y'^2)^{5/2}}
...
\sqrt{1+y'^2} + \epsilon\frac{y'}{\sqrt{1+y'^2}}$, to first order.  So
we have, again to first order

\begin{eqnarray}
RHS
&=& \sqrt{1+y'^2} + \epsilon\frac{y'}{\sqrt{1+y'^2}}  + \epsilon\phi_y(x,y)\sqrt{1+Y'^2}\\
&=& \sqrt{1+y'^2} + \epsilon\left(\frac{y'}{\sqrt{1+y'^2}}  + \phi_y(x,y)\sqrt{1+Y'^2}\right)\\
&=& \sqrt{1+y'^2} + \epsilon\left(\frac{y'}{\sqrt{1+y'^2}}  + \phi_y(x,y)\sqrt{1+y'^2}\right)\\
\end{eqnarray}
